...
const returnList = () => {
    const shopping = ['eggs', 'apples', 'milk', 'bread'];

    return new Promise ((resolve)=> resolve(shopping));
 };
...
const internalServerError = () => {
    const fiveHundred = {error:500};
    return new Promise ((resolve, reject)=> reject (fiveHundred));
};
...
// 1. make function that is my name, 2. promise that resolves passing back the function 
